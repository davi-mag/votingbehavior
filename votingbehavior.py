...
label_names = {
    ...
    'VotedCoalition': {1: 'CDS', 2: 'M5S', 3: 'TerzoPolo', 4: "CDX"},
...
# Assuming df_final is your processed DataFrame with 'VotedCoalition' as the outcome variable
X = df_final.drop('VotedCoalition', axis=1)
y = df_final['VotedCoalition']
...
# Decision Tree plot
plt.figure(figsize=(20, 10))
# Use target_names in the order of the classes used in clf.classes_
...
# Taken df_final2 and 'VotedCoalition' (target variable)
X = df_final2.drop('VotedCoalition', axis=1)
y = df_final2['VotedCoalition']
...
# Plot the decision tree
plt.figure(figsize=(20, 10))
plot_tree(best_clf, feature_names=X.columns, class_names=list(target_names.values()),
          filled=True, rounded=True, fontsize=8)
plt.show()
...
Now we move on with a random forest.
